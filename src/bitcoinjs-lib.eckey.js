...
Bitcoin.ECKey = (function () {
	...
	ECKey.privateKeyPrefix = 0x79; // mainnet 0x80    testnet 0xEF
	...
	*/
	...
	ECKey.isWalletImportFormat = function (key) {
		key = key.toString();
		return (ECKey.privateKeyPrefix == 0x79) ?
	...
	ECKey.isCompressedWalletImportFormat = function (key) {
		key = key.toString();
		return (ECKey.privateKeyPrefix == 0x79) ?
							(/^[KJ][123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{51}$/.test(key)) :
